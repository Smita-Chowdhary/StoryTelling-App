...
import { StyleSheet, View, Button, Touchable, Text, SafeAreaView, Platform,StatusBar,Image,Dimensions} from "react-native";
  ...
  signInWithGoogleAsync = async () => {
    try {
      const result = await Google.logInAsync({
        behaviour: "web",
        androidClientId:
          "508950211694-c7s7g48pkvcq3p9befom4lq20i9j2vv4.apps.googleusercontent.com",
        iosClientId:
